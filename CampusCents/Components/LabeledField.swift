...
struct LabeledField: View {
    ...
    init(_ title: String, value: Binding<String>, hint: String? = nil, placeholder: String? = nil, labelColor: Color = .secondary, textColor: Color = .primary, backgroundColor: Color? = nil) {
        self.title = title
        self._value = value
        self.hint = hint
